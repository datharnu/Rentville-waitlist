  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div
        ...
        style={{
          backgroundImage: `url(data:image/svg+xml;charset=utf8,%3Csvg%20viewBox%3…arent%22%20opacity%3D%221%22%20%2F%3E%3C%2Fsvg%3E), linear-gradient(146deg, rgba(255, 239, 219, 0.30) 0%, rgba(166, 223, 255, 0.141) 40%)`,
          backgroundColor: "rgba(252, 252, 252, 0)", // Adjust opacity as needed
        }}
      ></div>

      {/* Content container */}
      <div className="relative z-10 overflow-y-auto min-h-screen">
        <div className="background-with-noise lg:h-[80vh] h-[70vh] border-b-8 border-tertiary">
        ...
        {/* Image section with the description */}
        <article className=" border-tertiary border-b-8 lg:border-0" id="about">
          <div className=" lg:flex w-full lg:mt-32 mt-20 lg:w-[80%] mx-auto">
          ...
          <div className=" lg:flex w-full  lg:w-[80%] mx-auto">
            ...
            <div className="bg-white p-12 px-20  place-content-center text-center space-y-5 lg:w-1/2 ">
              ...
              <hr className="w-16 mx-auto border-2 border-tertiary" />
              <p className="  text-center text-[16px] text-text leading-8 lg:mx-5">
                With our integrated payment system, you can securely pay
                deposits and rent directly through the app. Your personal and
                financial information is protected with industry-standard
                encryption.
              </p>
            </div>
          </div>
          ...
          <div className=" lg:flex-row lg:flex justify-between lg:w-[80%] lg:mx-auto mx-20  flex flex-col-reverse place-items-center ">
            <div className="text-[#FFFFFF66] lg:w-1/2 space-y-5 lg:space-y-0 text-center lg:text-left mt-5 font-light text-sm ">
              ...
              <p className="mb-4">
                ...
                call{" "}
                <span className="text-tertiary font-thin">09070004086</span> or
                follow us on social media for the latest updates.
              </p>
              <p>©All rights reserved. 2024 B-10 Technologies</p>
            </div>
            <div className="flex items-center gap-5">
              <a href="https://www.facebook.com/rentville.ng/">
